...
namespace Aaina.Data
{
	public sealed class SqlHelper
	{
		...
		public static DataSet ExecuteDataset(object connectionstring, string v, SqlParameter sqlParameter1, SqlParameter sqlParameter2, SqlParameter sqlParameter3, SqlParameter sqlParameter4, SqlParameter sqlParameter5, SqlParameter sqlParameter6)
		{
		...
		public static DataSet ExecuteDataset(string connectionstring, string commandText, params SqlParameter[] commandParameters)
		{
			try
			{
				...
				using (SqlConnection connection = new SqlConnection(connectionstring))
				{
					connection.Open();
					// Call the overload that takes a connection in place of the connection string
					DataSet ds = ExecuteDataset(connection, CommandType.StoredProcedure, commandText, commandParameters);
					connection.Close();
					return ds;
				}
			}
		...
		public static DataSet ExecuteSP(string connectionString, string cmdSPName)
		{
			// Pass through the call providing null for the set of SqlParameters
			return ExecuteDataset(connectionString, CommandType.StoredProcedure, cmdSPName, (SqlParameter[])null);
		}
		...
		public static DataTable ExecuteDataTable(string connectionString, CommandType commandType, string commandText, params SqlParameter[] commandParameters)
		{
			...
			using (SqlConnection connection = new SqlConnection(connectionString))
			{
				...
				// Call the overload that takes a connection in place of the connection string
				DataTable ds = ExecuteDatatable(connection, commandType, commandText, commandParameters);
		...
		public sealed class Connection
		{
			...
			static Connection()
			{
				connStr = string.Empty;// ConfigurationSettings.AppSettings["DefaultConnection"].ToString();
			}
