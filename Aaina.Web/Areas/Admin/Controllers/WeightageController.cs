    ...
    public class WeightageController : BaseController
    {
        ...
        public async Task<IActionResult> AddEdit(WeightageDto model)
        {
            ...
            if (emojiImg != null)
            {
                ...
                {
                    ModelState.AddModelError("", $"Emoji image not valid, Please choose jpg,png,jpeg format");
                    return CreateModelStateErrors();
                }
            ...
            {
                ModelState.AddModelError("", $"Emoji image is required");
                return CreateModelStateErrors();
            }
            ...
            if (emojiImg != null)
                model.Emoji = emojiImg != null ? await this.UploadProfile(env, CurrentUser.CompanyId, emojiImg, $"{model.Emoji}-mini", "EmojiImages", new[] { ".png", ".jpg", ".jpeg" }, $"{model.Rating.Value.ToString()}-mini") : model.Emoji;
