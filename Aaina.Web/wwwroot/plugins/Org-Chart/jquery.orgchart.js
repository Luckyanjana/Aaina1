(function ($) {
    ...
    function OrgChart($container, opts) {
        ...
        this.addNodeWithOutEdit = function (data) {
            var newNode = new Node(data);
            nodes[data.id] = newNode;
            nodes[data.parent].addChild(newNode);
        ...
        this.UpdateNodeValueByIndex = function (id, strVal) {
            nodes[id].data.name = strVal;
            self.draw();
        }
        this.IsNodeExist = function (id) {
            return nodes[id] != undefined && nodes[id].data != undefined && nodes[id].data != null;
        }
        ...
        this.deleteFromSource = function (id) {
            for (var i = 0; i < nodes[id].children.length; i++) {
                self.deleteNode(nodes[id].children[i].data.id);
            }
            nodes[nodes[id].data.parent].removeChild(id);
